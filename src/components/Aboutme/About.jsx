    ...
    return (
        <div className="about-container" id="about-me">
            ...
            <div className="container text-center mt-5">
                <h1 className='first-name'>YASH BHOSALE</h1>
                <p className='personal-title'>Full-Stack Web Developer and Software Engineer</p>
                <p className='about-me'>
                    I'm a passionate full-stack web developer based in maharashtra,India.📍
                </p>

                <div className="mt-3 social-links-container">
                    <a className="social-links" href="https://www.linkedin.com/in/yash-bhosale-33398a192">
                        <FontAwesomeIcon icon={faLinkedin} className="fa-1x socail-icons" />
                    </a>
                    <a className="social-links" href="https://github.com/yashbhosalegithub">
